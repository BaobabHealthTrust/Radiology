...
module ApplicationHelper
  ...
  def version
    ...
    "Radiology: <span style=font-size:0.8em;>#{app_version}</span>- <span #{style}>#{(session[:datetime].to_date rescue Date.today).strftime('%A, %d-%b-%Y')}</span>&nbsp;&nbsp;"
  end
